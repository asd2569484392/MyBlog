...
<link href="<%=path%>/Back/assets/styles.css" rel="stylesheet"
	media="screen">
<link href="<%=path%>/Back/assets/DT_bootstrap.css" rel="stylesheet"
	media="screen">
<style type="text/css">
...
<body>
				...
				<div class="row-fluid">
					<div class="block">
						<div class="navbar navbar-inner block-header">
							<div class="muted pull-left">博客管理</div>
						</div>
							...
							<div class="span12">
								<div class="table-toolbar">
									<div class="btn-group">
										<a href="#"><button class="btn btn-success">
												添加新博客 <i class="icon-plus icon-white"></i>
											</button> </a>
									</div>
								...
								<table cellpadding="0" cellspacing="0" border="0"
									...
									<tbody>
										...
										%>
										<tr class="odd gradeX">
											<td><%=b.getBlog_title()%></td>
											<td><%=b.getBlog_keyword()%></td>
											<td><%=b.getBlog_time()%></td>
											<td><a href="<%=path%>/blogControl/readBlog.do?id=<%=b.getId()%>" class="btn">
													<i class="icon-eye-open"></i> View
												</a></td>
											<td class="center"><a
												href="<%=path%>/back/UpdateBlog.do?id=<%=b.getId()%>"
												class="btn btn-primary"><i
													class="icon-pencil icon-white"></i> Edit</a></td>
											<td class="center"><a href="<%=path %>/back/removeBlog.do?id=<%=b.getId()%>" class="btn btn-danger">
 ...
 <div id="myModal" class="modal hide">
	...
	<script
		src="<%=path%>/Back/vendors/datatables/js/jquery.dataTables.min.js"></script>

	<script type="text/javascript"
		src="<%=path%>/Back/assets/jquery.min.js"></script>
	<script type="text/javascript"
		src="<%=path%>/Back/assets/jquery.page.js"></script>
