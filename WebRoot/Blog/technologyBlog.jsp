...
<body>
    ...
    <!-- Page Header -->
    <header class="intro-header" style="background-image: url('<%=path %>/Blog/img/wallhaven-66208.jpg')">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                    <div class="site-heading">
                        <h1>Technology Blog</h1>
                        <span class="subheading">技术博客</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                ...
                <div class="post-preview">
                    <a href="<%=path%>/blogControl/readBlog.do?id=<%=b.getId()%>">
                        <h2 class="post-title">
                            <%=b.getBlog_title() %>
                        </h2>
                    ...
                    <p class="post-meta">Tag by:<a href="<%=path%>/blogControl/blogPage.do?tag=<%=b.getBlog_keyword() %>"><%=b.getBlog_keyword() %></a>&nbsp;&nbsp;date:<%=b.getBlog_time() %></p>
                </div>
                <hr>
                <%} %>
...
<script type="text/javascript">
    $("#pagination1").createPage({
					...
					backFn : function(p) {
					//alert(p);
					window.location.href="<%=path%>/blogControl/blogPage.do?p="+p;
		}
	});
