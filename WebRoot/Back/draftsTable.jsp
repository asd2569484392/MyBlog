<%@page import="xyz.yangchaojie.entity.Drafts"%>
...
<%List<Drafts> draftsList = (List<Drafts>)request.getAttribute("draftsList");%>
...
.light-theme .ellipse {
            ...
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
                     <div class="row-fluid">
                                ...
                                <div class="muted pull-left">草稿管理</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
                                    <div class="table-toolbar">
                                      <div class="btn-group">
                                         <a href="#"><button class="btn btn-success">写博客 <i class="icon-plus icon-white"></i></button></a>
                                      </div>
                                      <div class="btn-group pull-right">
                                         <button data-toggle="dropdown" class="btn dropdown-toggle">类型查询<span class="caret"></span></button>
                                         <ul class="dropdown-menu">
                                            <li><a href="<%=path%>/back/draftsPage.do?type=Article">文章</a></li>
                                            <li><a href="<%=path%>/back/draftsPage.do?type=Blog">博客</a></li>
                                            <li><a href="<%=path%>/back/draftsPage.do?type=InformalEssay">随笔</a></li>
                                         </ul>
                                      </div>
                                   </div>
                                    <label class = "label">这个标签看上去没什么屌用,实际上确实没什么屌用</label>
                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2">
                                        ...
                                        <tbody>
                            		<%for(Drafts d:draftsList){ %>
                                            <tr class="odd gradeX">
                                               <td><%=d.getDraft_title() %></td>
                                               <td><%=d.getDraft_keyword() %></td>
                                               <td><%=d.getDraft_type() %></td>
                                                <td><button class="btn"><i class="icon-eye-open"></i> 查看</button></td>
                                                <td class="center"> <a href = "<%=path %>/back/UpdateDraft.do?id=<%=d.getId() %>" class="btn btn-primary"><i class="icon-pencil icon-white"></i> 更新</a></td>
                                                <td class="center"><a href="<%=path %>/back/removeDraft.do?id=<%=d.getId() %>" class="btn btn-danger"><i class="icon-remove icon-white"></i> 删除</a></td>
 ...
 <div id="myModal" class="modal hide">
											<div class="modal-header">
												...
												<h3><%=request.getSession().getAttribute("LoginOK") %></h3>
											</div>
