                                   ...
                                   <div class="table-toolbar">
                            		...
                            		<%for(Article a:articleList){ %>
                                            <tr class="odd gradeX">
                                                ...
                                                <td><%=a.getArticle_title() %></td>
                                                <td><%=a.getArticle_time() %></td>
                                                 <td><%=a.getArticle_author() %></td>
                                                <td><a href="<%=path%>/articleControl/readArticle.do?id=<%=a.getId()%>" class="btn"><i class="icon-eye-open"></i> View</a></td>
                                                <td class="center"> <a href="<%=path %>/back/updateArticle.do?id=<%=a.getId() %>" class="btn btn-primary"><i class="icon-pencil icon-white"></i> Edit</a></td>
                                                <td class="center"><a href="<%=path %>/back/removeArticle.do?id=<%=a.getId() %>" class="btn btn-danger"><i class="icon-remove icon-white"></i> Delete</a></td>
